        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              ...
              src="../../assets/images/carouselvalorant.jpg"
            />
            <div class="container">
          ...
          <div class="carousel-item">
            <img
              class="object-fit-cover w-100 h-100"
              src="../../assets/images/carouselcounterstrike.jpg"
            />
            <div class="container">
          ...
          <div class="carousel-item">
            <img
              class="object-fit-cover w-100 h-100"
              src="../../assets/images/carouseleafc.jpg"
            />
            <div class="container">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <p>
              <a class="btn btn-secondary" href="../registration/registration.php"
                >Join event &raquo;</a
              >
            </p>
          </div>
          ...
          <div class="col-lg-4">
            ...
            >
              <title />
              <path
                d="M23.92,17.23l-7.07-11A.5.5,0,0,0,16.43,6h0a.5.5,0,0,0-.42.23L10.49,15H5.35l1-2H9.85a.5.5,0,0,0,.41-.21l1.4-2a.5.5,0,0,0-.41-.79H2.65a.5.5,0,0,0-.41.21l-1.4,2a.5.5,0,0,0,.41.79H2.45L.06,17.26A.5.5,0,0,0,.5,18H12.06a.5.5,0,0,0,.42-.23l3.92-6.25L17.2,13h-.54a.5.5,0,0,0-.41.21l-1.4,2a.5.5,0,0,0,.41.79h3.92l1.25,1.79a.5.5,0,0,0,.41.21H23.5a.5.5,0,0,0,.42-.77Z"
              />
              <path
                d="M4,9h8.63a.5.5,0,0,0,.41-.21l1.4-2A.5.5,0,0,0,14.07,6H5.45A.5.5,0,0,0,5,6.21l-1.4,2A.5.5,0,0,0,4,9Z"
              />
            </svg>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
              ...
              <span class="text-body-secondary"
                >Unleash Your Tactical Prowess</span
              >
            </h2>
            <p class="lead">
          ...
          <div class="col-md-5">
            <img
              class="object-fit-cover w-100 h-100"
              src="../../assets/images/playervalorant.jpg"
            />
          </div>
        </div>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <img
              class="object-fit-cover w-100 h-100"
              src="../../assets/images/playercounterstrike.jpeg"
            />
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">
              Game On, Champions.
              <span class="text-body-secondary"
                >Unleash Your Football Mastery.</span
              >
            </h2>
            <p class="lead">
          ...
          <div class="col-md-5">
            <img
              class="object-fit-cover w-100 h-100"
              src="../../assets/images/playereafc.jpg"
            />
          </div>
        </div>
